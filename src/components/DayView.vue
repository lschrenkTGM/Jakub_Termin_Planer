...
.accepted-val { color: #34a853; font-weight: 600; }
...
.btn-accept { background: #e6f4ea; color: #137333; }
.btn-accept:hover { background: #ceead6; }
.btn-unaccept { background: #fce8e6; color: #c5221f; }
